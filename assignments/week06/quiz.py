...
def count_vowels_consonants(text):
    ...
    text.replace("0", "") #Delete numbers
    text.replace("1", "") #Delete numbers
    text.replace("2", "") #Delete numbers
    text.replace("3", "") #Delete numbers
    text.replace("4", "") #Delete numbers
    text.replace("5", "") #Delete numbers
    text.replace("6", "") #Delete numbers
    text.replace("7", "") #Delete numbers
    text.replace("8", "") #Delete numbers
    text.replace("9", "") #Delete numbers
